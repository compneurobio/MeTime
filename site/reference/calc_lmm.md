...
Fits multiple Linear mixed models (LMM) to a longitudinal dataset.
...
- cols_for_meta:
  ...
  a list of character vector to define column names that are to be used
  for plotting purposes. Default set to NULL, therby not adding columns
  as metadata. If you want automated facet wrapping option then set your
