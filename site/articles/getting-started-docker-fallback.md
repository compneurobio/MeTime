...
If local R installation fails (system libraries, compiler issues, or
dependency conflicts), use the Docker image.
...
If no image argument is provided, the script will build `metime:local`
