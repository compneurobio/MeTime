...
> One-line summary: end-to-end pipeline showing how MeTime supported the core results of the preprint:
"A seven year old longitudinal study of the Alzheimer's Disease metabolome" (https://pubmed.ncbi.nlm.nih.gov/41409665/)

## Preparing data

Download the MXPQuant 500 dataset of ADNI and follow the preprocessing steps as described in the manuscript.
