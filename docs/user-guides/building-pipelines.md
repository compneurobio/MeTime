...
Here are a few examples for building pipelines see case studies example for more details
...
Example already shown in quickstart. The approach is the same for tSNE and UMAP
