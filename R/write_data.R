...
#' @seealso [write_results], [write_report]
#' @export
setGeneric("write_data", function(object, which_data, type) standardGeneric("write_data"))
setMethod("write_data", "metime_analyser", function(object, which_data, type) {
