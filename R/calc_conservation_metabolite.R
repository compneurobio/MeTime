...
#' This approach has been first described by \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4145193/}{Yousri et al. 2014, Long-term conservation of human metabolic phenotypes and link to heritability. *Metabolomics*} 
#' @seealso [calc_conservation_metabotype], [get_metadata_for_columns], [get_stratified_data]
