...
#' @export
setGeneric("write_analyser_object", function(object, which_data, type) standardGeneric("write_analyser_object"))
setMethod("write_analyser_object", "metime_analyser", function(object, which_data, type) {
